...
`gotth-authentik` versions independently under Semantic Versioning. A version number
...
5. Verify exact head and tag parity at
   `github.com/gotthboard/gotth-authentik` through the existing one-way push
   mirror.
